...
<html lang="en">
  <head>
    ...
    <title>Admin Area | Schools</title>
    <!-- Bootstrap core CSS -->
  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Schools<small></small></h1>
          </div>
        </div>
      </div>
    </header>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                <div class="row">
                      <div class="col-md-12">
                          <input class="form-control" type="text" placeholder="Filter Schools...">
                      </div>
                </div>
                <br>
                <table class="table table-striped table-hover" border=1>
                <tr><h4><u><center>
                  <th><h4><b><u>School Name</h4></b></th>
                  <th><h4><b><u>School Code</th>
                  <th><h4><b><u>City</th>
                  <th><h4><b><u>State</th>
                  <th><h4><b><u>Number Of Students</th>
                ...
                <?php  
                    ...
                    echo "<tr><td> ". $row["school_name"]. " </td><td> ". $row["school_code"]. " </td><td>" . $row["city"] . "</td><td>". $row["state"]. " </td><td> ". $row["student"]. " </td><td> ". $row["contact"]. "</td></tr>";
                    }
                        } else {
                            echo "0 results";
                        }
